...
exports.init = function () {
  return defaultClient.init.apply(defaultClient, arguments);
};
...
exports.track = function () {
  return defaultClient.track.apply(defaultClient, arguments);
};
...
exports.identify = function () {
  return defaultClient.identify.apply(defaultClient, arguments);
};
